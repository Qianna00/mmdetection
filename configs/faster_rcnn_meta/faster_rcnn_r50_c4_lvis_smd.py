...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'lvis/SMD_VIS_6_class_train_Qianna_lvis.json',
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            gs_config=dict(
                ...
                pred_slice='/root/data/zq/data/SMD/lvis/pred_slice_with0.pt',
                fg_split='/root/data/zq/data/SMD/lvis/valsplit.pkl',
